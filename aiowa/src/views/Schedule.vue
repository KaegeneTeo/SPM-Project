        ...
        <MainLayout>
            <header class="bg-white">
                <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                    ...
                    <!--FOR FILTERS, ONLY TEST WITH DEPT:SALES,CEO,HR-->
                </div>
            </header>
            ...
            <main class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 grid grid-cols-12 gap-4">
                ...
                <div v-if="role === '1'" class="col-span-12 lg:col-span-3">
                    <div>
                        <label for="schedule-selector-department" class="block text-sm font-medium text-gray-700">Select
                            Department:</label>
                        <select v-model="selectedDept" id="schedule-selector-department"
                    ...
                    <div class="mt-4">
                        <label for="schedule-selector-team" class="block text-sm font-medium text-gray-700">Select
                            Team:</label>
                        <select v-model="selectedTeam" id="schedule-selector-team"
                            class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    ...
                    <div class="mt-6">
                        <button id="search-button" @click="search"
                            class="bg-indigo-500 text-white px-4 py-2 rounded-md shadow-sm hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50">
                            Search
                        </button>
                    </div>
                </div>
                        ...
                        <template #cell-content="{ cell, view, goNarrower, events }">
                            ...
                            <span class="vuecalcell-events-count "
                                ...
                                <span style="background-color:#FFA500; color: white; "
                                    class="am-count px-2 h-4 w-4 rounded-full">{{ AMCount(events) }}</span>&nbsp;
                                <span style="background-color:#9C27B0; color: white; "
                                    class="pm-count px-2 h-4 w-4 rounded-full">{{ PMCount(events) }}</span>
                            </span>
