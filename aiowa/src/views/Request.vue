<template>
    <div class="max-w-6xl mx-auto p-6 bg-white shadow-md rounded-lg">
        ...
        <div class="flex space-x-4 mb-4">
            ...
            <button
                @click="goToViewRequestStaffPage"
            ...
            <table class="min-w-full bg-white border border-gray-300 shadow rounded-lg">
                ...
                <tbody>
                    <tr v-for="request in requests" :key="request.request_id" class="border-b hover:bg-gray-50">
                        <td
                            class="px-4 py-2 text-blue-600 underline cursor-pointer"
                            @click.prevent="openRequestDetails(request.request_id)">
                            {{ request.request_id }}
                        </td>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-gray-700">
                        <strong>Time Slot:</strong> {{ mapTimeSlot(selectedRequest.time_slot) }}
                    </p>
                    <p class="text-gray-700">
                        <strong>Request Type:</strong> {{ mapRequestType(selectedRequest.request_type) }}
                    </p>
                </div>
                ...
                <div class="flex space-x-4">
                    <button
                        ...
                        :class="{ 'opacity-50 cursor-not-allowed': !isApproveEnabled }">
                        Approve
                    </button>
                    <button
                        ...
                        :class="{ 'opacity-50 cursor-not-allowed': !isRejectEnabled }">
                        Reject
                    </button>
                </div>
            </div>
    ...
    methods: {
        ...
        async openRequestDetails(requestId) {
            ...
            try {
                ...
                this.affectedDates = this.calculateAffectedDates(
        ...
        async approveRequest() {
            ...
            try {
                const response = await axios.put(
                    `${VITE_AWS_URL}/request/${this.selectedRequest.request_id}/approve`,
                    {
        ...
        async rejectRequest() {
            ...
            try {
                const response = await axios.put(
                    `${VITE_AWS_URL}/request/${this.selectedRequest.request_id}/reject`,
                    {
                        result_reason: this.resultReason,
                    },
                    {
