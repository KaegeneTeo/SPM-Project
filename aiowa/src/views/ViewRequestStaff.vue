<template>
    <div>
      ...
      <input v-model="staffId" type="number" id="staffId" @keyup.enter="fetchRequests"/>
    ...
    methods: {
      async fetchRequests() {
        ...
        try {
          ...
          if (err.response && err.response.status === 404 && err.response.data.detail === "No requests found for this staff ID") {
            this.showNoRecords = true;
          } else {
