<template>
    <div class="max-w-5xl mx-auto p-6 bg-white shadow-md rounded-lg">
        ...
        <div v-else-if="requests.length === 0 && !error && showNoRecords" class="text-gray-700 mt-4">
            No records found for this staff ID.
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        withdrawRequest(request_id) {
            axios
                .delete(`${VITE_AWS_URL}/withdraw_request/${request_id}`)
        ...
        cancelRequest(request_id) {
            axios
                .delete(`${VITE_AWS_URL}/cancel_request/${request_id}`)
