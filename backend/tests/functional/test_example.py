...
# Test the /teams_by_reporting_manager route
def test_teams_by_reporting_manager(client, supabase_mock, mocker):
    mock_data = {
        "data": [
    ...
    assert json_data['teams'][0]['manager_name'] == "Unknown"  # Manager's name is retrieved separately
